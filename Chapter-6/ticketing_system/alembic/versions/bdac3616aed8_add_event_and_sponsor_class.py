"""Add event and sponsor class

Revision ID: bdac3616aed8
Revises: 1b3b7de22406
Create Date: 2025-12-30 12:10:54.198758
...
revision: str = 'bdac3616aed8'
down_revision: Union[str, Sequence[str], None] = '1b3b7de22406'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('tickets', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_tickets_events', 'events', ['event_id'], ['id'])
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('tickets', schema=None) as batch_op:
        batch_op.drop_constraint('fk_tickets_events', type_='foreignkey')
